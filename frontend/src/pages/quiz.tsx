            ...
            <>
                ...
                <div className='text-center mt-6'>
                    <Link href='/quiz/ranking'>
                        <button className='bg-indigo-600 text-white px-6 py-3 rounded-lg hover:bg-indigo-700 transition mr-4'>
                            퀴즈 랭킹 보기
                        </button>
                    </Link>
                    <button
            ...
            <div className='container mx-auto p-4 max-w-2xl bg-white rounded-lg shadow-lg'>
                ...
                <div className='mb-6'>
                    ...
                    <select
                        ...
                        className='border p-3 w-full mt-4 rounded-lg focus:ring-2 focus:ring-indigo-500 transition'
                    >
    ...
    return (
        <div className='container mx-auto p-4 text-center bg-white rounded-lg shadow-lg'>
            ...
            <p className='text-gray-500 mb-6'>
                문제를 푸는 도중 페이지를 벗어나거나 새로고침 시 저장되지 않으며 해당 이름으로 다시 시작할 수 없습니다.
            </p>
            <div className='max-w-md mx-auto mb-5 mt-10'>
                ...
                <button
                    ...
                    disabled={loading}
                    className='bg-indigo-600 text-white font-semibold py-3 px-6 rounded-lg shadow-lg hover:bg-indigo-700 transition w-full'
                >
                    {loading ? '시작 중...' : '퀴즈 시작'}
                </button>
                <Link href='/quiz/ranking'>
                    <button className='mt-10 w-full bg-gray-200 text-gray-800 font-semibold py-3 px-6 rounded-lg shadow hover:bg-gray-300 transition'>
                        퀴즈 랭킹 보기
                    </button>
                </Link>
            </div>
