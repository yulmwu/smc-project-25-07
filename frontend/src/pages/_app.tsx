...
export default function App({ Component, pageProps }: AppProps) {
    ...
    return (
        <div className="bg-gray-100 text-gray-900 min-h-screen">
            ...
            <div
                id="mobileSidebar"
                className={`fixed top-0 left-0 h-full w-64 bg-white shadow-lg z-40 transform transition-transform duration-300 ease-in-out ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}
            >
                <div className="p-4">
                    <h2 className="text-lg font-semibold mb-3">카테고리</h2>
                    <ul className="space-y-2 text-sm">
                        <li><a href="#" className="hover:underline">전체</a></li>
                        <li><a href="#" className="hover:underline">질문</a></li>
                        <li><a href="#" className="hover:underline">정보</a></li>
                        <li><a href="#" className="hover:underline">자유</a></li>
                    </ul>
                </div>
            </div>
            ...
            <header className="bg-white shadow px-4 py-3 sticky top-0 z-20 flex justify-between items-center">
                ...
                <nav className="space-x-4 text-sm">
                    <a href="#" className="text-gray-600 hover:text-black">홈</a>
                    <a href="#" className="text-gray-600 hover:text-black">인기</a>
                    <a href="#" className="text-gray-600 hover:text-black">최신</a>
                </nav>
            </header>
